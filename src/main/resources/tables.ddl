...
CREATE CACHED TABLE "PUBLIC"."PROCESS_INSTANCE"(
    "CREATED_AT" TIMESTAMP(6),
    "CURRENT_TASK_INSTANCE_ID_FK" BIGINT,
    ...
    "PROCESS_PARAMS" CHARACTER VARYING(255),
    "STATUS" ENUM('ABORTED', 'COMPLETED', 'READY_TO_START', 'STARTED')
)
